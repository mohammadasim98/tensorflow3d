...
sampling_module = tf.load_op_library('tensorflow3d/clib/ops/sampling/tf_sampling_so.so')
grouping_module = tf.load_op_library('tensorflow3d/clib/ops/grouping/tf_grouping_so.so')
interpolate_module = tf.load_op_library('tensorflow3d/clib/ops/3d_interpolation/tf_interpolate_so.so')
